...
<title>Head/Admin with 6 units.</title>
...
<body><div class= "container">
    <div class="box">
    <br><br>
        <h1 class = "text-white bg-danger"><strong>This form is for head/admin members with 6 units.</h1></strong>
        ...
        <form action="">
            ...
            <h4><strong> You can input 2 to 3 subjects.</h4></strong>
            
            <label><strong><h4 class = "text-danger">Last preferred subject</h4></strong></label>
            <input type="text"name ="sub3" id = "input" class = "form-control form-control-m" placeholder="Last preferred subject"><br><br>
			<ul class = "list"></ul>
...
fwrite($file, "Last preferred subject :");
fwrite($file, $sub3 . "\n");
