...
<div class= "container">
    ...
    <br><br>
        ...
        <form action="">
            ...
            <label><h4 class = "text-primary">Fourth preferred subject</h4></strong></label>
            <input type="text"name ="sub4" id = "input" class = "form-control form-control-m" placeholder="Fourth preferred subject"><br><br>
            <ul class = "list"></ul>

            <button> INPUT </button>
            <br>
            <br>
            <a class="btn btn-success btn-lg" href="fte_5.php" role="button">ADD SUBJECTS</a>
