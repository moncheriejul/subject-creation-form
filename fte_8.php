...
<div class= "container">
    ...
    <br><br>
        ...
        <form action="">
            ...
            <label><h4 class = "text-primary">Eighth preferred subject</h4></strong></label>
            <input type="text"name ="sub8" id = "input" class = "form-control form-control-m" placeholder="Eighth preferred subject"><br><br>
            <ul class = "list"></ul>
            
            <button> INPUT </button>
            <br>
            <br>
            <a class="btn btn-success btn-lg" href="fte_9.php" role="button">ADD SUBJECTS</a>
