...
<div class= "container">
    ...
    <br><br>
        ...
        <form action="">
            ...
            <label><h4 class = "text-success">Fifth preferred subject</h4></strong></label>
            <input type="text"name ="sub5" id = "input" class = "form-control form-control-lg" placeholder="Fifth preferred subject"><br><br>
            <ul class = "list"></ul>

            <button> INPUT </button>
            <br>
            <br>
            <a class="btn btn-success btn-lg" href="par_6.php" role="button">ADD SUBJECTS</a>
