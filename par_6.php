...
<div class= "container">
    ...
    <br><br>
        ...
        <form action="">
            ...
            <label><h4 class = "text-success">Sixth preferred subject</h4></strong></label>
            <input type="text"name ="sub6" id = "input" class = "form-control form-control-lg" placeholder="Sixth preferred subject"><br><br>
            <ul class = "list"></ul>

            <button> INPUT </button>
            <br>
            <br>
            <a class="btn btn-success btn-lg" href="par_7.php" role="button">ADD SUBJECTS</a>
