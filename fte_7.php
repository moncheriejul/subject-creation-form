...
<div class= "container">
    ...
    <br><br>
        ...
        <form action="">
            ...
            <label><h4 class = "text-primary">Seventh preferred subject</h4></strong></label>
            <input type="text"name ="sub7" id = "input" class = "form-control form-control-m" placeholder="Seventh preferred subject"><br><br>
            <ul class = "list"></ul>

            <button> INPUT </button>
            <br>
            <br>
            <a class="btn btn-success btn-lg" href="fte_8.php" role="button">ADD SUBJECTS</a>
