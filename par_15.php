...
<div class= "container">
    ...
    <br><br>
        ...
        <form action="">
            ...
            <label><h4 class = "text-success">Fifteenth preferred subject</h4></strong></label>
            <input type="text"name ="sub15" id = "input" class = "form-control form-control-lg" placeholder="Fifteenth preferred subject"><br><br>
            <ul class = "list"></ul>
...
fwrite($file, "15th preferred subject :");
fwrite($file, $sub15 . "\n");
