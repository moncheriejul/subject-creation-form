...
<body>
    ...
    <label><strong><h4> What is your preferred time? (Choose only from 7:00 - 12:00)</h4></strong></label>
            ...
            <br>
            <br>
            <a class="btn btn-success btn-lg" href="head-3_2.php" role="button">ADD SUBJECTS</a>
            <a class="btn btn-primary btn-lg" href="overload-head.php" role="button">OVERLOAD</a>
