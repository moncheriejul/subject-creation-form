...
<div class= "container">
    ...
    <br><br>
        ...
        <form action="">
            ...
            <label><strong><h4 class = "text-success">Most preferred subject</h4></strong></label>
            ...
            <br>
            <br>
            <a class="btn btn-success btn-lg" href="par_2.php" role="button">ADD SUBJECTS</a>
            <a class="btn btn-danger btn-lg" href="delete-par.html" role="button">DELETE</a>    
            <a class="btn btn-secondary btn-lg" href="parttime.php" role="button">BACK</a> 
        </form>  
