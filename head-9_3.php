...
<body><div class= "container">
    ...
    <br><br>
        ...
        <form action="">
            ...
            <label><strong><h4 class = "text-danger">Third preferred subject</h4></strong></label>
            <input type="text"name ="sub3" id = "input" class = "form-control form-control-m" placeholder="Third preferred subject"><br><br>
			<ul class = "list"></ul>
            
            <button> INPUT </button>
            <br>
            <br>
            <a class="btn btn-success btn-lg" href="head-9_4.php" role="button">ADD SUBJECTS</a>
...
fwrite($file, "Third preferred subject :");
fwrite($file, $sub3 . "\n");
